...
<head>
    ...
    <!-- GOOGLE WEB FONT -->
    <link href="<?php echo  base_url(); ?>https://fonts.googleapis.com/css?family=Poppins:300,400,500,600,700,800" rel="stylesheet">
...
<body class="fixed-nav sticky-footer" id="page-top">
            ...
            <ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
                <li class="nav-item" data-toggle="tooltip" data-placement="right" title="My profile">
                    <a class="nav-link nav-link-collapse collapsed" data-toggle="collapse" href="#collapseProfile" data-parent="#exampleAccordion">
                        ...
                        <span class="nav-link-text">Kategori Psikotes</span>
                    </a>
                    <ul class="sidenav-second-level collapse" id="collapseProfile">
                        <li>
                            <a href="user-profile.html">1</a>
                        </li>
                        <li>
                            <a href="doctor-profile.html">2</a>
                        </li>
                        <li>
                            <a href="doctor-profile.html">3</a>
                        </li>
                    </ul>
                </li>
                <li class="nav-item" data-toggle="tooltip" data-placement="right" title="My profile">
                    ...
                    <ul class="sidenav-second-level collapse" id="collapseProfile">
                        <li>
                            <a href="user-profile.html">Edit Profil</a>
                        </li>
                    </ul>
                </li>
            </ul>
        ...
        <div class="container-fluid">
            ...
            <ol class="breadcrumb">
                <li class="breadcrumb-item">
                    <a href="#">Layanan Psikotes Online</a>
                </li>
    ...
    <script src="<?php echo  base_url(); ?>assets/vendor/jquery.selectbox-0.2.js"></script>
    <script src="<?php echo  base_url(); ?>assets/vendor/retina-replace.min.js"></script>
    <script src="<?php echo  base_url(); ?>assets/vendor/jquery.magnific-popup.min.js"></script>
